...
const router = createRouter({
  ...
  routes: [
    ...
    },
    {
      ...
      component: DefaultLayout,
      children: [
        { path: '', name: 'jobs', component: () => import('@/views/jobs/JobListView.vue') },
      ],
    },
    {
      path: '/jobs/:id',
      component: DefaultLayout,
      children: [
        { path: '', name: 'job-detail', component: () => import('@/views/jobs/JobDetailView.vue') },
      ],
    },
      ...
      children: [
        {
          ...
          component: () => import('@/views/student/ApplicationListView.vue'),
        },
      ],
    },
    {
      ...
      children: [
        {
          path: '',
          name: 'my-favorites',
          component: () => import('@/views/student/FavoriteListView.vue'),
        },
      ],
    },
    {
      ...
      children: [
        {
          path: '',
          name: 'my-complaints',
          component: () => import('@/views/student/ComplaintListView.vue'),
        },
      ],
    },
      ...
      children: [
        {
          path: '',
          name: 'employer-jobs',
          component: () => import('@/views/employer/JobListView.vue'),
        },
      ],
    },
    {
      ...
      children: [
        {
          ...
          component: () => import('@/views/employer/JobCreateView.vue'),
        },
      ],
    },
    {
      ...
      children: [
        {
          ...
          component: () => import('@/views/employer/JobEditView.vue'),
        },
      ],
    },
    {
...

    {
      ...
      children: [
        { path: '', name: 'my-profile', component: () => import('@/views/ProfileView.vue') },
      ],
    },

...
<template>
  <div class="card">
    ...
    <p class="footer">还没有账号？<RouterLink to="/register">立即注册</RouterLink></p>
  </div>
</template>

<style scoped>
.card { width: 360px; padding: 24px; background: #fff; border-radius: 10px; box-shadow: 0 8px 30px rgba(15,23,42,.08); }
